...
final class Tokens extends Enum
{
    ...
    private const PREFIX_NULLABLE = 297;
    private const PREFIX_NEGATED = 298;
    private const PAREN_LEFT = 299;
    private const PAREN_RIGHT = 300;
    private const TOKEN_COMMA = 301;
    private const TOKEN_ARROW = 302;
    private const GENERIC_LIST_START = 303;
    private const GENERIC_LIST_END = 304;
