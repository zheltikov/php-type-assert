    ...
    protected function initReduceCallbacks()
    {
        $this->reduceCallbacks = [
            ...
            2 => function ($stackPos) {
                ...
                $this->semValue->appendChild($this->semStack[$stackPos - (3 - 1)])->appendChild(
            ...
            17 => function ($stackPos) {
                ...
                $this->semValue->setValue($this->semStack[$stackPos - (3 - 1)] . '\\' . $this->semValue->getValue());
            },
            18 => function ($stackPos) {
                $this->semValue = $this->semStack[$stackPos - (2 - 2)];
                $this->semValue->setValue('\\' . $this->semValue->getValue());
            },
